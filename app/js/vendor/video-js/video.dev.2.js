...
vjs.TextTrack.prototype.load = function() {
    ...
    if (this.readyState_ === 0) {
        this.readyState_ = 1;
        vjs.get(this.src_, vjs.bind(this, this.encoding), vjs.bind(this, this.onError));
    }
...
vjs.TextTrack.prototype.encoding = function(srcSubtitle) {
    ...
    var this_ = this;
    decode(srcSubtitle, this_.language, vjs.bind(this_, this_.parseCues));
    ////fer
